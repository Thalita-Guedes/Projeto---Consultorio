...
void AtualizarFuncionario(void){
    ...
    {
    .tipo = texto,
    .pergunta = "Digite o NOME COMPLETO do Funcionário que deseja consultar",
    .resposta = criterioBusca,
    .tamanho = sizeof(criterioBusca)
    },
    {
    .tipo = texto,
    .pergunta = "Escolha um campo para alterar (Nome, Idade, Altura, Peso, RG, CPF, Endereço, Telefone, Email, Gênero, Código, CRM , Especialidade)",
    .resposta = campo,
...
Menu("Atualizar Funcionário", &listaOpcoes[0]);
